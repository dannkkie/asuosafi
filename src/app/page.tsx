  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC] text-slate-900 font-sans selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white border border-slate-200 p-2.5 sm:p-3 rounded-xl shadow-sm">
          
          {/* Status Filter Segmented Controls */}
          <div className="flex items-center gap-1.5 overflow-x-auto">
            <div className="flex items-center gap-1.5 text-xs text-slate-500 mr-1 hidden md:flex font-mono font-medium">
            ...
            {[
              ...
              { id: 'critical_toxic', label: 'Critical Hazard', dot: 'bg-red-600' },
              { id: 'caution_turbid', label: 'Caution', dot: 'bg-amber-600' },
              { id: 'safe', label: 'Potable Safe', dot: 'bg-emerald-600' },
            ].map((f) => {
          ...
          <div className="flex items-center gap-1 bg-slate-100 border border-slate-200 rounded-lg p-1 shrink-0 self-end sm:self-auto">
            <button
            ...
            >
              <TableIcon className="h-3.5 w-3.5 text-sky-700" />
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
                <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-100">
                  ...
                  <button
                    onClick={() => setActiveView('table')}
                    className="text-xs text-sky-700 hover:text-sky-900 flex items-center gap-1 font-mono font-medium transition-colors cursor-pointer"
                  >
                      ...
                      >
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-1.5">
                            <p className="font-semibold text-xs text-slate-900 truncate">{pt.name}</p>
                            {isCur && (
                        ...
                        <div className="text-right shrink-0">
                          <span className={`font-mono text-xs font-bold block ${
                            isTox ? 'text-red-700' : isSafe ? 'text-emerald-700' : 'text-amber-700'
                          }`}>
          ...
          <div className="space-y-6 animate-in fade-in duration-200">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
              <div className="max-w-3xl space-y-2">
                <span className="text-[10px] font-mono uppercase tracking-wider px-2 py-0.5 rounded bg-amber-50 text-amber-900 border border-amber-200 font-bold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5 space-y-3 shadow-sm">
                <div className="h-9 w-9 rounded-lg bg-emerald-50 text-emerald-800 border border-emerald-200 flex items-center justify-center">
                  <Scale className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="font-bold text-sm text-slate-900">Act 522 (Water Resources)</h4>
                  <p className="text-[11px] font-mono text-emerald-700 font-semibold mt-0.5">Section 24 & Section 29</p>
                </div>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5 space-y-3 shadow-sm">
                <div className="h-9 w-9 rounded-lg bg-amber-50 text-amber-800 border border-amber-200 flex items-center justify-center">
                  <ShieldAlert className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="font-bold text-sm text-slate-900">Act 995 (Mining Amendment)</h4>
                  <p className="text-[11px] font-mono text-amber-700 font-semibold mt-0.5">Section 99 & Section 100</p>
                </div>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5 space-y-3 shadow-sm">
                <div className="h-9 w-9 rounded-lg bg-sky-50 text-sky-800 border border-sky-200 flex items-center justify-center">
                  <ShieldCheck className="h-5 w-5" />
                </div>
                <div>
                  <h4 className="font-bold text-sm text-slate-900">Act 720 (Whistleblower)</h4>
                  <p className="text-[11px] font-mono text-sky-700 font-semibold mt-0.5">Section 12 & Section 18</p>
                </div>
                <p className="text-xs text-slate-600 leading-relaxed">
                  ...
                  >
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-xs text-slate-900">{pt.name}</span>
                        <span className="text-[10px] font-mono text-red-800 bg-red-100 px-1.5 py-0.2 rounded border border-red-200 font-bold">
                          {pt.metrics.turbidityNtu} NTU
                        </span>
                      </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 space-y-2.5 shadow-sm">
              <div className="h-8 w-8 rounded-lg bg-emerald-50 text-emerald-800 border border-emerald-200 flex items-center justify-center">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 space-y-2.5 shadow-sm">
              <div className="h-8 w-8 rounded-lg bg-sky-50 text-sky-800 border border-sky-200 flex items-center justify-center">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 space-y-2.5 shadow-sm">
              <div className="h-8 w-8 rounded-lg bg-amber-50 text-amber-800 border border-amber-200 flex items-center justify-center">
      ...
      <footer className="border-t border-slate-200 bg-white py-6 px-4 sm:px-6 text-xs text-slate-500">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-slate-600">
            <strong className="text-slate-900">AsuoSafi</strong> • National Extractive Water & Environmental Safety Ledger
          </p>
