...
export const SafeAlternativeFinder: React.FC<SafeAlternativeFinderProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-[#1f1f1f] border border-emerald-300 dark:border-[#254228] rounded-[12px] dark:rounded-[6px] p-4 text-[#1f2124] dark:text-white shadow-material dark:shadow-none space-y-3.5">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <span className="text-[10px] sm:text-xs font-mono uppercase px-2 py-0.5 rounded-[4px] bg-emerald-50 dark:bg-[#172319] text-emerald-800 dark:text-[#a7f3d0] border border-emerald-200 dark:border-[#254228] font-semibold">
      ...
      <div className="bg-[#f8f9fa] dark:bg-[#141414] border border-[#e0e2e6] dark:border-[#2a2a2a] rounded-[8px] dark:rounded-[4px] p-3">
        <div className="flex justify-between items-start">
          <div>
            <h4 className="font-bold text-sm sm:text-base text-[#1f2124] dark:text-white font-sans">{safeAlternative.name}</h4>
            <p className="text-xs text-[#4b5563] dark:text-[#cbd5e1] mt-0.5">{safeAlternative.community}, {safeAlternative.district}</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2 mt-3 pt-2.5 border-t border-[#e0e2e6] dark:border-[#2a2a2a] text-center text-xs">
          <div className="bg-white dark:bg-[#1f1f1f] rounded-[6px] dark:rounded-[4px] p-1.5 border border-[#e0e2e6] dark:border-[#2a2a2a]">
            <span className="text-[11px] text-[#4b5563] dark:text-[#cbd5e1] block uppercase font-mono font-medium">Distance</span>
            <span className="font-mono font-bold text-[#1f2124] dark:text-white mt-0.5 block">{distanceKm} km</span>
          </div>

          <div className="bg-white dark:bg-[#1f1f1f] rounded-[6px] dark:rounded-[4px] p-1.5 border border-[#e0e2e6] dark:border-[#2a2a2a]">
            <span className="text-[11px] text-[#4b5563] dark:text-[#cbd5e1] block uppercase font-mono font-medium">Walking Time</span>
            <span className="font-mono font-bold text-[#1f2124] dark:text-white mt-0.5 block">~{walkingMinutes} min</span>
          </div>

          <div className="bg-white dark:bg-[#1f1f1f] rounded-[6px] dark:rounded-[4px] p-1.5 border border-[#e0e2e6] dark:border-[#2a2a2a]">
            <span className="text-[11px] text-[#4b5563] dark:text-[#cbd5e1] block uppercase font-mono font-medium">Water Purity</span>
      ...
      <div className="flex items-center justify-between gap-3 pt-1">
        <div className="flex items-center gap-1.5 text-xs text-[#4b5563] dark:text-[#cbd5e1]">
