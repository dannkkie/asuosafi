...
export const PetitionModal: React.FC<PetitionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#141414]/80 p-3 sm:p-6 overflow-y-auto">
      <div className="bg-white dark:bg-[#1f1f1f] border border-[#e0e2e6] dark:border-[#2a2a2a] rounded-[12px] dark:rounded-[6px] max-w-3xl w-full max-h-[90vh] flex flex-col shadow-2xl dark:shadow-none overflow-hidden text-[#1f2124] dark:text-white animate-in fade-in duration-150">
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs text-[#4b5563] dark:text-[#cbd5e1] mt-0.5">
                Official citizen legal instrument for <strong className="text-[#1f2124] dark:text-white font-bold">{waterPoint.name}</strong>
              </p>
            </div>
          </div>
        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-4 text-xs sm:text-sm text-[#1f2124] dark:text-white bg-white dark:bg-[#1f1f1f]">
          ...
          <div className="bg-[#f8f9fa] dark:bg-[#141414] border border-[#e0e2e6] dark:border-[#2a2a2a] rounded-[8px] dark:rounded-[4px] p-4 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            <div>
              ...
              <p className="text-xs text-[#4b5563] dark:text-[#cbd5e1] mt-0.5">{waterPoint.district}, {waterPoint.region} Region</p>
            </div>
            ...
            <div className="sm:text-right">
              ...
              <p className="text-xs text-[#4b5563] dark:text-[#cbd5e1] font-mono mt-0.5">{petition.date}</p>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid gap-1.5">
              {petition.statutoryCitations.map((citation, index) => (
                <div key={index} className="flex items-start gap-2 bg-[#f8f9fa] dark:bg-[#141414] border border-[#e0e2e6] dark:border-[#2a2a2a] p-2.5 rounded-[6px] dark:rounded-[4px] text-xs text-[#1f2124] dark:text-white">
          ...
          <div>
            <span className="text-xs uppercase font-mono tracking-wider text-[#4b5563] dark:text-[#cbd5e1] font-semibold block mb-1">
              Statutory Instrument Full Text
            </span>
            <pre className="bg-[#f8f9fa] dark:bg-[#141414] p-4 rounded-[8px] dark:rounded-[4px] border border-[#e0e2e6] dark:border-[#2a2a2a] font-mono text-xs leading-relaxed text-[#1f2124] dark:text-white whitespace-pre-wrap max-h-44 overflow-y-auto">
        ...
        <div className="bg-[#f8f9fa] dark:bg-[#181818] border-t border-[#e0e2e6] dark:border-[#2a2a2a] p-4 flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full dark:rounded-[4px] text-xs font-medium bg-white dark:bg-[#141414] hover:bg-[#f1f3f4] dark:hover:bg-[#252525] text-[#1f2124] dark:text-white border border-[#e0e2e6] dark:border-[#2a2a2a] shadow-material dark:shadow-none transition-colors cursor-pointer"
            >
              <Printer className="h-3.5 w-3.5 text-[#4b5563] dark:text-[#cbd5e1]" />
